...
if ($is_existing_match) {
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("issiidiii", $match_id, $batting_team_id, $bowling_team_id, $current_score['runs'], $current_score['wickets'], $overs_decimal, $striker_id, $non_striker_id, $bowler_id);
}
